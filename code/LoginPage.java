...
class LoginPage extends JFrame implements ActionListener
{
  ...
  String getLoginNode(String user, String pass)
  {
	try(BufferedReader br=new BufferedReader(new FileReader("users.txt")))
	{
	  String line="",words[];
	  while((line=br.readLine())!=null)
	  {
		...
		if(words.length >= 4 && words[0].compareTo(user)==0 && words[1].compareTo(pass)==0)
		 return words[3];
	  }
	}
	catch(Exception e)
  ...
  public void actionPerformed(ActionEvent ae)
  {
	...
	else
	{
	    ...
	    String loginNode = getLoginNode(User, Pass);
	
	    if(loginNode != null)
	    {
	      success.setText("Login Successful"); 
	      new Dashboard(loginNode);
	    }
	    else
	    {
